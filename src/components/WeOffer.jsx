          ...
          <div className="border-0.75 relative flex h-full flex-col justify-between rounded-xl p-6 md:p-6 dark:shadow-[0px_0px_27px_0px_#2D2D2D]">
            ...
            <div className="mt-auto">
              <div className="space-y-2 sm:space-y-3 mb-3">
                ...
                <div className="font-sans text-sm/[1.125rem] text-white md:text-base/[1.375rem] [&_b]:md:font-semibold [&_strong]:md:font-semibold">
              ...
              {button && (
                <a
                  ...
                  className="inline-flex items-center gap-2 mt-2 px-4 py-2 bg-transparent border border-gray-600 rounded-lg text-sm text-white hover:bg-gray-800 transition-all dark:hover:bg-gray-700 group"
                >
                  {button}
        ...
        <div className="border-0.75 relative flex h-full flex-col justify-between gap-4 overflow-y-auto rounded-xl p-6 md:p-6 dark:shadow-[0px_0px_27px_0px_#2D2D2D]">
          ...
          {button && (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 mt-3 px-4 py-2 bg-transparent border border-gray-600 rounded-lg text-sm text-white hover:bg-gray-800 transition-all dark:hover:bg-gray-700 group"
            >
              {button}
              <ExternalLink className="h-4 w-4 transition-transform group-hover:translate-x-1 group-hover:-translate-y-1" />
            </a>
