...
const ContactUs = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    fetch("https://formsubmit.co/ajax/hello@backpackwander.de", {
      method: "POST",
      body: formDataToSend,
      headers: {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <motion.div
            ...
            className="bg-black/30 rounded-xl p-6 md:p-8 shadow-lg backdrop-blur-md"
          >
                ...
                <div key={idx} className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    {key === "address" ? (
                      ...
                      <p className="text-sm">hello@backpackwander.de</p>
                    ) : (
                      <>
                        <p className="text-sm">
